...
>
  ...
  style={{
    ...
    gap: "10px" // শুধুমাত্র flex parent থাকলে কাজ করে
  }}
  viewBox="0 0 20 20"
  fill="none"
  xmlns="http://www.w3.org/2000/svg"
...
>
  ...
  />
      ...
      {/* Cart Box */}
      {openCart && (
        <div className="absolute right-20 top-[90px] w-[250px] p-4 bg-white border rounded-lg shadow-lg">
      ...
      {openProfile && (
        <div className="absolute right-4 top-[90px] w-[220px] bg-white border rounded-lg shadow-lg">
          <ul className="text-[14px]">
            ...
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={() => navigate("/Account")}>Your Orders</li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer"onClick={() => navigate("/Account")}>Your Wish List</li>
            <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Your Recommendation</li>
